...
class AboutViewModel: ViewModel {
    ...
    var iconsDescriptionAttributedString: NSAttributedString {
        ...
        icon8Link.addAttribute(NSLinkAttributeName, value: L10n.icons8UrlSource, range: NSMakeRange(0, icon8Link.length))
    ...
    var usedLibsAttributedString : NSAttributedString {
        ...
        alamoLink.addAttribute(NSLinkAttributeName, value: L10n.urlAlalmofire, range: NSMakeRange(0, alamoLink.length))
        alamoLicense.addAttribute(NSLinkAttributeName, value: L10n.licenseAlmofire, range: NSMakeRange(0, alamoLicense.length))
        ...
        swiftyJSONLink.addAttribute(NSLinkAttributeName, value: L10n.urlSwiftyjson, range: NSMakeRange(0, swiftyJSONLink.length))
        siwftyJSONLizenz.addAttribute(NSLinkAttributeName, value: L10n.licenseSwiftyjson, range: NSMakeRange(0, siwftyJSONLizenz.length))
        ...
        reachabilityLink.addAttribute(NSLinkAttributeName, value: L10n.urlReachability, range: NSMakeRange(0, reachabilityLink.length))
        reachabilityLizenz.addAttribute(NSLinkAttributeName, value: L10n.licenseReachability, range: NSMakeRange(0, reachabilityLizenz.length))
        ...
        fabricLink.addAttribute(NSLinkAttributeName, value: L10n.urlFabric, range: NSMakeRange(0, fabricLink.length))
        fabricLizenz.addAttribute(NSLinkAttributeName, value: L10n.licenseFabric, range: NSMakeRange(0, fabricLizenz.length))
